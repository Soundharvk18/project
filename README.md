...
<body>
            ...
            <div class="row text-center">
                <div class="col-md-4">
                    <div class="card border-0">
                        <img src="music1.jpg" class="card-img-top" alt="Latest News">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card border-0">
                        <img src="music2.jpg" class="card-img-top" alt="Top Reviews">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card border-0">
                        <img src="music3.jpg" class="card-img-top" alt="Community">
                        <div class="card-body">
    ...
    <section id="games" class="bg-light py-5">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        <img src="music4.jpg" class="card-img-top" alt="Game 1">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <img src="music6.jpg" class="card-img-top" alt="Game 2">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <img src="music5.jpg" class="card-img-top" alt="Game 3">
                        <div class="card-body">
    ...
    <footer>
        <div class="container">
            <p class="mb-0"  >&copy; 2024 Organised By Jeya soundhar</p>
        </div>
    </footer>
...
```
# OUTPUT:
![Screenshot 2024-12-23 181812](https://github.com/user-attachments/assets/19a67aba-e338-4f8a-9c91-000a471fa81d)
![Screenshot 2024-12-23 181823](https://github.com/user-attachments/assets/c5726a97-45d1-4ea0-bd12-735762795132)
![Screenshot 2024-12-23 181839](https://github.com/user-attachments/assets/eecf925a-4836-4ebe-8404-a78a988586e1)
